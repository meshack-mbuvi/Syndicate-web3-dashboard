...
const AudacityPage = () => {
  return (
    ...
    >
        ...
        <p className="mb-3 text-gray-300 opacity-80">Culture is the Future of Money and Asset Management. Culturally dynamic crypto technology:</p>
        <ol className="list-decimal mb-3 text-gray-300 opacity-80 pl-8">
