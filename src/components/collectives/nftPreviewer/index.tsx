      ...
      {!mediaSource && !name && !description ? (
        <div
          className={clsx(
            maxWidth,
            maxHeight,
            'flex h-120 flex-col md:ml-0 mx-auto my-auto text-gray-syn4 w-full items-center justify-center'
          )}
        >
        ...
        <div
          className={clsx(
            'h-full mx-auto md:ml-0 border border-gray-syn6 rounded-2.5xl overflow-hidden',
            customClasses,
            maxWidth
          )}
        >
          ...
          >
            ...
            {mediaType === NFTMediaType.IMAGE && (
              <div
                ...
                style={{
                  backgroundImage: `url(${mediaSource as string})`,
                  ...
                  showAutoGeneratedArtDisclaimer && (
                    ...
                    >
                      <img
                        ...
                        alt="Custom NFT disclaimer modal"
                        className="mx-auto"
                      />
                    </button>
                  )}
