...
export const Header = () => {
  return (
    <div className="flex px-4">
      ...
      <span className="uppercase text-gray-dim text-xs mx-1 w-20">Created</span>
      <span className="uppercase text-gray-dim text-xs mx-2 w-40">Status</span>
      ...
      <span className="uppercase text-gray-dim text-xs mx-2">My Deposits</span>
      <span className="uppercase text-gray-dim text-xs mx-2">
        My withdrawals
      </span>
