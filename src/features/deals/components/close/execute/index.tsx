...
interface Props {
  ...
  handleCancelAllowance?: () => void;
  transactionFailed?: boolean;
  showWaitingOnExecutionLoadingState?: boolean;
  successfullyWithdrawnDeal?: boolean;
        ...
        <StepsOutline
          ...
          steps={[
                    ...
                    >
                      <div className="w-1/3">
                        <B3 extraClasses="text-gray-syn3">
                          {closeType === DealEndType.EXECUTE ? (
                            ...
                            successfullyWithdrawnDeal ? (
                            <B3 extraClasses="my-1">Status</B3>
                          ) : closeType === DealEndType.WITHDRAW &&
                            !successfullyWithdrawnDeal ? (
                      ...
                      <div className="w-2/3">
                        {closeType === DealEndType.EXECUTE ? (
                          ...
                          <div className="w-2/3">
                            <B3>
                              set all contributions to zero and close deal
                            </B3>
                          </div>
                        )}
                      </div>
                  ...
                  >
                    ...
                    >
                      {closeType === DealEndType.EXECUTE ? (
                        ...
                        <B2 extraClasses="mb-1">Dissolving deal</B2>
                      ) : closeType === DealEndType.WITHDRAW ? (
                        <B2 extraClasses="mb-1">Withdrawing from deal</B2>
                      ) : (
                        ''
                      )}
                      <B4 extraClasses="text-gray-syn3">
                        This could take up to a few minutes depending on network
                        congestion and the gas fees you set. Feel free to leave
                        this screen.
                      </B4>
                    </Callout>
                    ...
                    <Callout type={CalloutType.WARNING}>
                      {closeType === DealEndType.EXECUTE ? (
                        ...
                        <B2 extraClasses="mb-1">Deal dissolve failed</B2>
                      ) : closeType === DealEndType.WITHDRAW ? (
                        <B2 extraClasses="mb-1">Deal withdrawal failed</B2>
                      ) : (
                        ''
                      )}
                      <B4 extraClasses="text-gray-syn3">
            ...
            },
            {
              ...
              description: (
                <>
                  <div className="py-3 space-y-2 flex-col">
                    {/* Table */}
                    <div className="border border-gray-syn6 divide-y rounded-custom mb-4">
                      {/* Top row */}
                      <div
                    ...
                    >
                      ...
                      >
                        <B2 extraClasses="mb-1">
                          Cancel allowance in your wallet
                        </B2>
                        <B4 extraClasses="text-gray-syn3">
                          This action cancels any access to your wallet the
                          smart contract has currently
                        </B4>
                      </Callout>
                      ...
                      >
                        ...
                        <B4 extraClasses="text-gray-syn3">
                          This could take up to a few minutes depending on
                          network congestion and the gas fees you set. Feel free
                      ...
                      {/* Execution failed: we don't have this state in the designs. needs to be added */}
                      <Callout type={CalloutType.WARNING}>
                        <B2 extraClasses="mb-1">Cancel allowance failed</B2>
                        <B4 extraClasses="text-gray-syn3">
                          <span>
                            Please try again and
                            <EmailSupport
