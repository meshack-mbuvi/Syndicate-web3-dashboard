...
export const SET_SYNDICATE_ACTION = "SET_SYNDICATE_ACTION";
export const SET_SYNDICATE_DETAILS = "SET_SYNDICATE_DETAILS";
export const LOADING_SYNDICATE_DETAILS = "LOADING_SYNDICATE_DETAILS";
export const LOADING_SYNDICATE_LP_DETAILS = "LOADING_SYNDICATE_LP_DETAILS";
export const SET_SYNDICATE_LP_DETAILS = "SET_SYNDICATE_LP_DETAILS";
