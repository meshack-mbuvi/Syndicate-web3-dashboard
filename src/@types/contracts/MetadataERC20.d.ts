...
export interface MetadataERC20Contract
  extends Truffle.Contract<MetadataERC20Instance> {
  'new'(meta?: Truffle.TransactionDetails): Promise<MetadataERC20Instance>;
}
...
export interface MetadataERC20Instance extends Truffle.ContractInstance {
  ...
  testBasicSetMetadataOverlapKeys: {
    (txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(txDetails?: Truffle.TransactionDetails): Promise<void>;
