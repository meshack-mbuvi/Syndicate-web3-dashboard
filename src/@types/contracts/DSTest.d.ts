...
export interface DSTestContract extends Truffle.Contract<DSTestInstance> {
  'new'(meta?: Truffle.TransactionDetails): Promise<DSTestInstance>;
}
...
export interface DSTestInstance extends Truffle.ContractInstance {
