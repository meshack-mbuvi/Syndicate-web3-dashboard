...
export interface MintSynERC20Contract
  extends Truffle.Contract<MintSynERC20Instance> {
  'new'(meta?: Truffle.TransactionDetails): Promise<MintSynERC20Instance>;
}
...
export interface MintSynERC20Instance extends Truffle.ContractInstance {
  ...
  testOwnerCannotRagekickByDefault: {
    (txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(txDetails?: Truffle.TransactionDetails): Promise<void>;
