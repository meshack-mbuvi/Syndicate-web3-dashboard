...
export interface SynERC20TestContract
  extends Truffle.Contract<SynERC20TestInstance> {
  'new'(meta?: Truffle.TransactionDetails): Promise<SynERC20TestInstance>;
}
...
export interface SynERC20TestInstance extends Truffle.ContractInstance {
