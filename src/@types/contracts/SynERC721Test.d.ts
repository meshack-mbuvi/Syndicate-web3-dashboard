...
export interface SynERC721TestContract
  extends Truffle.Contract<SynERC721TestInstance> {
  'new'(meta?: Truffle.TransactionDetails): Promise<SynERC721TestInstance>;
}
...
export interface SynERC721TestInstance extends Truffle.ContractInstance {
