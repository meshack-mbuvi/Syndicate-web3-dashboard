...
export interface SynERC20MembersContract
  extends Truffle.Contract<SynERC20MembersInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<SynERC20MembersInstance>;
}
...
export interface SynERC20MembersInstance extends Truffle.ContractInstance {
