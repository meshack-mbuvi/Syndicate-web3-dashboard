...
export interface CreateSynERC20Contract
  extends Truffle.Contract<CreateSynERC20Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<CreateSynERC20Instance>;
}
...
export interface CreateSynERC20Instance extends Truffle.ContractInstance {
