...
export interface CreationFeeSynERC20Contract
  extends Truffle.Contract<CreationFeeSynERC20Instance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<CreationFeeSynERC20Instance>;
}
...
export interface CreationFeeSynERC20Instance extends Truffle.ContractInstance {
