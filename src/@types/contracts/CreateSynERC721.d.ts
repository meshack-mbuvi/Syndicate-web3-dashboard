...
export interface CreateSynERC721Contract
  extends Truffle.Contract<CreateSynERC721Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<CreateSynERC721Instance>;
}
...
export interface CreateSynERC721Instance extends Truffle.ContractInstance {
