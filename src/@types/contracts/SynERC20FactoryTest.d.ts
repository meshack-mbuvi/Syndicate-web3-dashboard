...
export interface SynERC20FactoryTestContract
  extends Truffle.Contract<SynERC20FactoryTestInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<SynERC20FactoryTestInstance>;
}
...
export interface SynERC20FactoryTestInstance extends Truffle.ContractInstance {
