...
export interface MultiMintSynERC721Contract
  extends Truffle.Contract<MultiMintSynERC721Instance> {
  'new'(meta?: Truffle.TransactionDetails): Promise<MultiMintSynERC721Instance>;
}
...
export interface MultiMintSynERC721Instance extends Truffle.ContractInstance {
  ...
  testMultiMintAdjustedForCapBasic: {
    (txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(txDetails?: Truffle.TransactionDetails): Promise<void>;
