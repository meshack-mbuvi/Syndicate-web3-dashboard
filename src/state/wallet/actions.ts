...
export const setConnectedProviderName = createAction<string>(
  'wallet/setConnectedProviderName'
);
...
export const showErrorModal = createAction<IModalErrors>(
  'wallet/showErrorModal'
);
export const hideErrorModal = createAction('wallet/hideErrorModal');
export const storeEthereumNetwork = createAction<IEthereumNetwork>(
  'wallet/storeEthereumNetwork'
);
export const storeCurrentEthNetwork = createAction<string>(
  'wallet/storeCurrentEthNetwork'
);
