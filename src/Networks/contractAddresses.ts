export const CONTRACT_ADDRESSES: { [key: number]: { [key: string]: string } } =
  Object.freeze({
    // Ethereum Mainnet
    1: {
      ...
      MerkleDistributorModuleERC721:
        '0xCaeE041fFa50165ba009EF2d7b00C1D2b0874a44',
    ...
    5: {
      ...
      MerkleDistributorModuleERC721:
        '0x4d66954dc81b13314c90a5e87464248813b77422',
      mintPolicy: '',
      policyMintERC20: '',
      ...
      AllowancePrecommitModuleERC20:
        '0x0a98468cf18DB558B1d6BF831C4895Db0F45837C',
    ...
    137: {
      ...
      MerkleDistributorModuleERC721:
        '0x1D73B78249363c6B5Cb6A0AdD6a1Cf21D5390eF2',
